...
/*------------------------------------------------------Macros-------------------------------------------------------*/
/*********************************************************************************************************************/
#define CHANNELS_NUM    2                       /* Number of used channels                                          */
...
IfxVadc_ChannelId g_vadcChannelIDs[] = {IfxVadc_ChannelId_4,  /* AIN0: channel 4 of group 7                         */
                                        IfxVadc_ChannelId_5};  /* AIN1: channel 5 of group 7                         */
...
void initVADCGroup(void)
{
    ...
    adcGroupConf.groupId = IfxVadc_GroupId_7;                           /* Select the Group 7                       */
